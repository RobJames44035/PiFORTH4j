...
import com.rajames.forth.pi.components.exceptions.RfidCollisionException;
import com.rajames.forth.pi.components.exceptions.RfidException;
import com.rajames.forth.pi.components.exceptions.RfidTimeoutException;
import com.rajames.forth.pi.components.exceptions.RfidUnsupportedCardException;
import com.rajames.forth.pi.components.helpers.ByteHelpers;
...
public class MFRC522 extends Component {
    ...
    private PiccResponse sendPiccRequest(PcdCommand command, Set<PcdComIrq> waitIrq, byte[] txData, int txLastBits, int rxAlignBits, boolean checkCrc) throws RfidException {
        ...
        if (earlyError != null) {
            throw new RfidException(String.valueOf(earlyError));
        }
