...
public final class MifareKey {
    ...
    /**
     * Returns the default factory key (six times 0xFF) to be used as {@link Type#KEY_A}.
     *
    ...
    /**
     * Returns the default factory key (six times 0xFF) to be used as {@link Type#KEY_B}.
     *
