...
class Abs extends AbstractRuntime {
 ...
 */
    ...
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        Integer topValue = interpreter.dataStack.pop() as Integer
        Integer absoluteValue = Math.abs(topValue)
        interpreter.dataStack.push(absoluteValue)
        return null
    }
}
