...
class StarSlashMod extends AbstractRuntime {
 ...
 */
    ...
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        Integer n3 = interpreter.dataStack.pop() as Integer // divisor
        Integer n2 = interpreter.dataStack.pop() as Integer // multiplier
        Integer n1 = interpreter.dataStack.pop() as Integer // to be multiplied and then divided
        Integer product = n1 * n2
        Integer remainder = product % n3
        Integer quotient = (product / n3) as Integer
        interpreter.dataStack.push(remainder)
        interpreter.dataStack.push(quotient)
        return null
    }
}
