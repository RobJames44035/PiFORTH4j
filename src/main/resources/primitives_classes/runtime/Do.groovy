...
class Do extends AbstractRuntime {
 ...
 */
    ...
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        ...
        Integer limit = interpreter.dataStack.pop() as Integer

        // The order of limit and index here is significant: we're making use of a Last-In-First-Out stack
