...
class Forth extends AbstractRuntime {
    ...
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        // Set the context vocabulary to 'FORTH'
        interpreter.forthRepl.CONTEXT = interpreter.forthRepl.FORTH_DICTIONARY_NAME
        // Set the current vocabulary to 'FORTH'
        interpreter.forthRepl.CURRENT = interpreter.forthRepl.FORTH_DICTIONARY_NAME
        return null
    }
}
