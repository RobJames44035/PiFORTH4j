...
class Begin extends AbstractRuntime {
     ...
     */
    // : test1 begin cr ." Hello " 0 until ;
    @Override
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        // Keep the execution index at "BEGIN" for use with "UNTIL"
        // This will allow interpreter to jump back to this point
        interpreter.returnStack.push(parentWord.executionIndex)
        return false
    }
}
