...
class Execute extends AbstractRuntime {
    ...
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        Long xt = interpreter.dataStack.pop() as Integer
        Word executeMe = interpreter.wordService.getById(xt)
        interpreter.executeWord(executeMe, null)
        return null
    }
}
