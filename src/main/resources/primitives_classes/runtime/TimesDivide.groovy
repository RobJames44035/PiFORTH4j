...
class TimesDivide extends AbstractRuntime {
 ...
 */
    ...
    Object execute(ForthInterpreter interpreter, Word word, Word parentWord) {
        Integer n3 = interpreter.dataStack.pop() as Integer
        Integer n2 = interpreter.dataStack.pop() as Integer
        Integer n1 = interpreter.dataStack.pop() as Integer
        Integer n4 = ((n1 * n2) / n3) as Integer
        interpreter.dataStack.push(n4)
        return null
    }
}
